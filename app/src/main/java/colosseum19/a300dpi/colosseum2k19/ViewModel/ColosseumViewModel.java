...
public class ColosseumViewModel extends ViewModel {
    ...
    private LiveData<List<FixtureEntry>> allFixtureEntries;
    private LiveData<List<ScoreEntry>> allScoreEntries;
    private LiveData<List<ScoreEntry>> scoreEntries;

    ColosseumViewModel(ColosseumDatabase colosseumDatabase) {
        this.colosseumDatabase = colosseumDatabase;
        allFixtureEntries = colosseumDatabase.colosseumDao().loadAllFixtures();
        allScoreEntries = colosseumDatabase.colosseumDao().loadAllSCores();
    ...
    public LiveData<List<FixtureEntry>> getAllFixtureEntries() {
        return allFixtureEntries;
    }

    public LiveData<List<ScoreEntry>> getAllScoreEntries() {
